...
public class JavaQuestionRepositoryTest {
    ...
    @Test
    public Question checkAddJavaQuestionAnswer(){
        String question = "Question1?";
        String answer = "Answer1.";
        Question q = new Question(question,answer);

        assertEquals(q,javaQuestionRepository.add(question,answer));
        return q;
    }

    @Test
    public void checkAddJavaQuestion(){
        String question = "Question1?";
        String answer = "Answer1.";
        Question q = new Question(question,answer);

        assertEquals(q,javaQuestionRepository.add(q));
    }

    @Test
    public void checkRemoveJavaQuestion(){
        String question = "Question1?";
        String answer = "Answer1.";
        Question q = new Question(question,answer);

        javaQuestionRepository.add(q);
        javaQuestionRepository.add("Question2?","Answer2.");
        javaQuestionRepository.add("Question3?","Answer3.");

        assertEquals(q,javaQuestionRepository.remove(q));
    }
    ...
    public void checkGetAll(){
        ...
        assertEquals(exp, javaQuestionRepository.getAll());
    }
    ...
    public void checkNullQuestionAdd(String question, String answer){
        assertThrows(EmptyQuestionException.class,()-> javaQuestionRepository.add(question, answer));
    }

    @ParameterizedTest
    @MethodSource("checkInvalidAnswer")
    public void checkNullAnswerAdd(String question, String answer){
        assertThrows(EmptyAnswerException.class,()-> javaQuestionRepository.add(question, answer));
    }
    ...
    public void checkRemoveQuestionNotFound(){
        ...
        assertThrows(QuestionNotFoundException.class,()->javaQuestionRepository.remove(q99));
    }
